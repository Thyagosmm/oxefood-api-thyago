...
public class ClienteController {
    ...
    @Operation(summary = "Serviço responsável por listar um cliente especifico do sistema.")
    ...
    @Operation(summary = "Serviço responsável por alterar dados de um cliente especifico do sistema.")
    ...
    @Operation(summary = "Serviço responsável por excluir um cliente especifico do sistema.")
    ...
    @Operation(summary = "Serviço responsável por salvar um novo endereço do cliente no sistema.")
    ...
    @Operation(summary = "Serviço responsável por atualizar os dados de um endereço do cliente do sistema.")
    ...
    @Operation(summary = "Serviço responsável por remover um endereço de um cliente no sistema.")
